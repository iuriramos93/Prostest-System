...
BEGIN
    ...
    -- Verificar se a tabela credores existe
    IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'credores') THEN
        -- Inserir credores
    ...
    -- Verificar se a tabela devedores existe
    IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'devedores') THEN
        -- Inserir devedores
    ...
    -- Verificar se a tabela remessas existe
    IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'remessas') THEN
        -- Inserir remessas
    ...
    IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'titulos') THEN
        -- Inserir títulos
    ...
    -- Verificar se a tabela desistencias existe
    IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'desistencias') THEN
    ...
    -- Verificar se a tabela erros existe
    IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'erros') THEN
        -- Inserir erros
        ...
        ON CONFLICT (remessa_id, titulo_id) DO NOTHING;
    END IF;

    -- Verificar se a tabela autorizacoes_cancelamento existe
    IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'autorizacoes_cancelamento') THEN
        ...
        ON CONFLICT (arquivo_nome) DO NOTHING;
    END IF;

    -- Verificar se a tabela transacoes_autorizacao_cancelamento existe
    IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'transacoes_autorizacao_cancelamento') THEN
        ...
        ON CONFLICT (autorizacao_id, titulo_id) DO NOTHING;
    END IF;
END $$;